...
- [x] 1. Permission Types and Core Definitions
...
- [x] 1.1 Write unit tests for permission types
  - Test PermissionMode validation
  - Test domain extraction edge cases
  - _Requirements: AC1_

- [x] 2. Permission Manager Implementation
...
- [x] 5. Checkpoint - Test Core Permission System
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Permission Dialog Component
...
- [x] 8. Settings Page Permissions Section
