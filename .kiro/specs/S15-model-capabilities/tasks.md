...
- [x] 1. Capability Constants and Types
...
- [x] 2.1 Write tests for model warnings
  - Test warning detection logic
  - Test alert rendering
  - _Requirements: AC2_

- [x] 3. Vision Fallback Implementation
...
- [x] 4. Checkpoint - Test Vision Fallback
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Streaming Adaptation
...
- [x] 7. Model Registry Verification
